...
document.addEventListener('DOMContentLoaded', function() {
    ...
    .then(([dataM, dataP, dataG]) => {
        ...
        if(diaSemana === 0 || diaSemana === 6 || horaC < 7 || horaC > 22) {
            ...
            for (let i = 0; i < 13; i++) {
                let elemento = dataG[i + 27][horaVi][diaSemana - 1];
                let elementoM = dataM[i + 27][horaVi][diaSemana - 1];
                let elementoP = dataP[i + 27][horaVi][diaSemana - 1];
